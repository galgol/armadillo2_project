...
from sim_push_button import push_button
import move_arm
...
class armadillo_elevator_node:
    ...
    def __init__(self):
        ...
        rospy.Subscriber("/softkinetic/color/image_raw/compressed", CompressedImage, self.intel_callback)
    ...
    def move_control5(self, cv_image, img_width, img_height):
        ...
        torso_h = 0.529621 - 0.00116279 * button_center
