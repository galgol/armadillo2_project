...
import rospy
import actionlib
from elevator.msg import SimpleTargetAction2, SimpleTargetGoal2
...
def target_move(x, y, z, frame_id):
    target_client = actionlib.SimpleActionClient('simple_target', SimpleTargetAction2)
